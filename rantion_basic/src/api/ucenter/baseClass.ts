...
class SysTableauViewResponseDto {
	/** contentUrl */
	contentUrl = ''
...
class SysTableauWorkbookResponseDto {
	/** contentUrl */
	contentUrl = ''
	...
	dataAccelerationConfig = undefined
...
class SysUserTableauRequestDto {
	/** tableau账号 */
	tableauNo = ''
...
export const ucenter = {
	...
	SysRoleDataRequestDto,
	SysRoleRequestDto,
	SysRoleResourceRequestDto,
	SysRoleResourceResponseDto,
	SysRoleResponseDto,
	SysTableauResponseDto,
	SysTableauViewResponseDto,
	SysTableauWorkbookResponseDto,
	SysUserDataRequestDto,
	SysUserLoginLogRequestDto,
	SysUserLoginLogResponseDto,
	SysUserRequestDto,
	SysUserResponseDto,
	SysUserTableauRequestDto,
