...
const port = 4324 // dev port
// const publicPath = process.env.NODE_ENV === 'development' ? `/` : '/'
const publicPath = process.env.NODE_ENV === 'development' ? `http://127.0.0.1:${port}/` : '/child-app/basics/'
module.exports = {
	publicPath,
	outputDir: 'dist',
	assetsDir: 'static',
	...
	devServer: {
		...
		proxy: {
			'/serverApi/rantion-basics': {
				target: 'http://192.168.120.177:9007',
				pathRewrite: { '^/serverApi/rantion-basics': '' }
			},
			'/serverApi': {
